...
mod tests {
    ...
    fn setup() -> crate::solver::Solver {
        let cnf = CNFDescription {
            num_of_variables: 5,
            num_of_clauses: 6,
            pathname: "".to_string(),
        };
        let mut s = crate::solver::Solver::instantiate(&Default::default(), &cnf);
    ...
    fn attach_clause<'a>(s: &'a mut crate::solver::Solver, vec: &[Lit]) -> &'a mut Clause {
