...
fn conflict_analyze(
    ...
    asg.activity_diffusion_tmp = (0, 0);
    loop {
        match reason {
            AssignReason::BinaryLink(l) => {
                let vi = l.vi();
    ...
    asg.activity_diffusion
        .update(asg.activity_diffusion_tmp.0 as f64 / asg.activity_diffusion_tmp.1 as f64);
